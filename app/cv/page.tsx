        ...
        <div className="mx-auto max-w-4xl pt-5 px-6">
            ...
            <div className="text-center mb-12 relative">
                ...
                <div className="absolute top-0 right-0 z-10">
                    <a href="/JingyiZhang_CV_academic.pdf" className="inline-flex items-center rounded-md px-3 py-1.5 text-sm font-medium hover:bg-gray-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600" style={{backgroundColor: '#E5E7EB', color: '#000000'}} target="_blank" rel="noopener noreferrer">
            ...
            <div className="mb-12">
                ...
                <div className="mb-6">
                    ...
                    <div>
                        ...
                        <p className="mb-1" style={{color: '#7F7F7F'}}><span className="font-normal">Thesis:</span> <Link href="/projects/MasterThesis" className="group inline-flex items-baseline" target="_blank" rel="noopener noreferrer"><svg className="w-4 h-4 mr-1 text-yellow-600" style={{color: '#ca8a04'}} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M12.586 4.586a2 2 0 112.828 2.828l-3 3a2 2 0 01-2.828 0 1 1 0 00-1.414 1.414 4 4 0 005.656 0l3-3a4 4 0 00-5.656-5.656l-1.5 1.5a1 1 0 101.414 1.414l1.5-1.5zm-5 5a2 2 0 012.828 0 1 1 0 101.414-1.414 4 4 0 00-5.656 0l-3 3a4 4 0 105.656 5.656l1.5-1.5a1 1 0 10-1.414-1.414l-1.5 1.5a2 2 0 11-2.828-2.828l3-3z" clipRule="evenodd"></path></svg><span className="font-light group-hover:text-yellow-600 group-hover:underline">"Supporting Co-Presence in Virtual Environments by Actor Control of Multiple Avatars"</span></Link>, <span className="font-normal">Supervisor:</span> <span className="font-light">Prof. Anthony Steed</span> <span className="text-yellow-600 font-medium" style={{color: '#ca8a04'}}>Developed to a <Link href="/publications/ismar2023" className="group inline-flex items-baseline" target="_blank" rel="noopener noreferrer"><svg className="w-4 h-4 mr-1 text-yellow-600" style={{color: '#ca8a04'}} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M12.586 4.586a2 2 0 112.828 2.828l-3 3a2 2 0 01-2.828 0 1 1 0 00-1.414 1.414 4 4 0 005.656 0l3-3a4 4 0 00-5.656-5.656l-1.5 1.5a1 1 0 101.414 1.414l1.5-1.5zm-5 5a2 2 0 012.828 0 1 1 0 101.414-1.414 4 4 0 00-5.656 0l-3 3a4 4 0 105.656 5.656l1.5-1.5a1 1 0 10-1.414-1.414l-1.5 1.5a2 2 0 11-2.828-2.828l3-3z" clipRule="evenodd"></path></svg><span className="group-hover:text-yellow-600 group-hover:underline">Paper</span></Link> submitted to ISMAR 2023</span></p>
                    </div>
                </div>
