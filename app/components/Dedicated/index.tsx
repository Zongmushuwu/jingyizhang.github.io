            ...
            <div className='mx-auto max-w-7xl px-4 my-2 lg:my-40 lg:px-8'>
                <div className='grid grid-cols-1 md:grid-cols-2 my-2 lg:my-16'>
                    ...
                    <div className="relative">
                        ...
                        <p className="font-medium text-lightblack text-xl mt-5 text-left">I am Jingyi Zhang, a third-year PhD student at <a href="https://www.ucl.ac.uk" className="underline">UCL</a>, in the <a href="https://www.ucl.ac.uk/engineering/computer-science/research/research-groups-and-centres/virtual-environments-and-computer-graphics" className="underline">VECG Group</a>, supervised by <a href="https://wp.cs.ucl.ac.uk/anthonysteed/" className="underline">Prof. Anthony Steed</a> and Prof. Ifat Yasin.</p>
